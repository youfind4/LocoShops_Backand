...
class Market extends Model implements HasMedia
{
    ...
    protected $casts = [
        ...
        // VPN Changes At :- 28/07/2020
        'is_google_enable' => 'boolean',
        'is_paytm_enable' => 'boolean',
        'google_token_key' => 'string',
        'paytm_token_key' => 'string'
        // End VPN Changes At :- 28/07/2020
    ];
    ...
    public static $adminRules = [
        ...
        // VPN Changes At :- 28/07/2020
        'paytm_token_key'   =>  'required_with:paytm_token',
        'google_token_key'   =>  'required_with:google_pay_token',
        // End VPN Changes At :- 28/07/2020
