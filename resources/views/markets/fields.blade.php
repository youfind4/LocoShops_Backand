...
@hasrole('admin')
<div class="col-12 custom-field-container">
    <h5 class="col-12 pb-4">Paymet Options</h5>
    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
        <!-- Users Field -->
        
        <div class="form-group row">
            {!! Form::label('google_pay', trans("lang.google_pay"), ['class' => 'col-3 control-label text-right']) !!}
            @if(isset($market))
            <div class="col-9">
                <label class="switch-part">
                  <input type="checkbox" id="google_pay_token" name="google_pay_token" value="1" @if($market->is_google_enable == 1)  checked @else  @endif onclick="google_pay()">
                  <span class="slider-inner round"></span>
                </label>
            </div>
            @else
            <div class="col-9">
                <label class="switch-part">
                  <input type="checkbox" id="google_pay_token" name="google_pay_token" value="1" {{ (! empty(old('google_pay_token')) ? 'checked' : '') }} onclick="google_pay()">
                  <span class="slider-inner round"></span>
                </label>
            </div>
            @endif
        ...
        <div class="form-group row" id="googlepay_token_div" style="display: none">
            {!! Form::label('google_pay_token', trans("lang.google_pay_token"), ['class' => 'col-3 control-label text-right']) !!}
            <div class="col-9">
                 {!! Form::text('google_token_key', null,  ['class' => 'form-control','placeholder'=>  trans("lang.market_google_token_key_placeholder")]) !!}
                <div class="form-text text-muted">
                    {{ trans("lang.market_google_token_key_help") }}
                </div>
            </div>
        </div>

         <div class="form-group row">
            {!! Form::label('paytm', trans("lang.paytm"), ['class' => 'col-3 control-label text-right']) !!}
            @if(isset($market))
            <div class="col-9">
                <label class="switch-part">
                  <input type="checkbox" id="paytm_token" name="paytm_token" onclick="paytm()" value="1" @if($market->is_paytm_enable == 1)  checked @endif>
                  <span class="slider-inner round"></span>
                </label>
            </div>
            @else
            <div class="col-9">
                <label class="switch-part">
                    <input type="checkbox" id="paytm_token" name="paytm_token" value="1" {{ (! empty(old('paytm_token')) ? 'checked' : '') }} onclick="paytm()">
                  <span class="slider-inner round"></span>
                </label>
            </div>
            @endif
         ...
         <div class="form-group row" id="paytm_token_div" style="display: none">
            {!! Form::label('paytm_token', trans("lang.paytm_token"), ['class' => 'col-3 control-label text-right']) !!}
            <div class="col-9">
                 {!! Form::text('paytm_token_key', null,  ['class' => 'form-control','placeholder'=>  trans("lang.market_paytm_token_key_placeholder")]) !!}
                <div class="form-text text-muted">
                    {{ trans("lang.market_paytm_token_key_help") }}
                </div>
            </div>
        </div>  
    </div>
